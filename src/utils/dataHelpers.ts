...
export function getAvailableSchools(): string[] {
  ...
  return ["brown", "harvard", "yale", "princeton", "cornell", "dartmouth", "upenn", "utexasaustin", "stanford", "caltech", "cmu", "ucla", "ucberkeley", "columbia", "mit", "nyu", "northwestern", "duke", "vanderbilt"];
}
