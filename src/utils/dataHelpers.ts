...
export function getAvailableSchools(): string[] {
  ...
  return ["bostonuniversity", "brown", "caltech", "cmu", "columbia", "cornell", "dartmouth", "duke", "emory", "georgiatech", "harvard", "johnshopkins", "mit", "northeastern", "notredame", "nyu", "northwestern", "princeton", "rice", "purdue", "stanford", "ucla", "ucberkeley", "ucdavis", "uci", "uchicago", "uiuc", "umich", "upenn", "usc", "utexasaustin", "uva", "vanderbilt", "yale"];
}
