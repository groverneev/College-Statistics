...
import CSEnrollmentReversalStory from "@/components/trends/stories/CSEnrollmentReversalStory";
import InternationalEnrollmentStory from "@/components/trends/stories/InternationalEnrollmentStory";
...
const storyComponentMap: Record<string, ComponentType> = {
  ...
  "cs-enrollment-reversal": CSEnrollmentReversalStory,
  "international-enrollment-exposure": InternationalEnrollmentStory,
